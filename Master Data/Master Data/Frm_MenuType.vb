...
#End Region
    ...
    Private Sub Frm_SPMaterialReceiveCash_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'DataSet.view_menutype' table. You can move, or remove it, as needed.
        Me.View_menutypeTableAdapter.Fill(Me.DataSet.view_menutype)
    ...
    Sub NewProcess()
        Try
            ...
            DetailLayout()
            ViewmenutypeGridControl.DataSource = Me.DataSet.view_menutype
            ViewmenutypeBindingSource.AddNew()
    ...
    Private Sub HomeLayout()
        ...
        isUpdate = False
        ViewmenutypeGridControl.DataSource = ViewmenutypeBindingSource
    ...
    Private Sub SB_Back_Click(sender As Object, e As EventArgs) Handles SB_Back.Click
        Try
            Me.Cursor = Cursors.WaitCursor
            DxErrorProvider.ClearErrors()
            ViewmenutypeBindingSource.CancelEdit()
            HomeLayout()
        Catch ex As Exception
