...
Public Class CR_BarcodeLabel
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Master_Data.CR_BarcodeLabel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_BarcodeLabel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_BarcodeLabel = New CR_BarcodeLabel()
        rpt.Site = Me.Site
        Return rpt
    End Function
